...
public class URL {
    ...
    public static final String LOTTE_MOVIE_PICTURE_URL = "http://www.lottecinema.co.kr/LCWS/Movie/MovieData.aspx";
    ...
    public static final String MEGABOX_SELECT_THEATER = ".footer_theater .wrap .clearfix dd a";
    public static final String MEGABOX_SELECT_MOVIE_INFO = ".timetable_container .movie_time_table.v2 tbody .lineheight_80";


    public static final String MEGABOX_THEATER_URL = "http://image2.megabox.co.kr/mop/base/footer_theater.html";
    public static final String MEGABOX_SELECT_THEATER_INFO = "#menu3.section.no4 script";

    String test = " #container.theater_container #menu3.selection.no4";
