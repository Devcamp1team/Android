package com.yapp.no_11.yapp_1team.utils.nmap;

/**
 * Created by HunJin on 2017-12-26.
 */

public class NMapPOIflagType {
    public static final int CURRENT_POINT = 1;
    public static final int THEATER_POINT = 2;
