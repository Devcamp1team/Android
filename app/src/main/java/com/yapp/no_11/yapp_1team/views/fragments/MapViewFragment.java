...
// TODO: 2017-12-19 marker click event
// TODO: 2017-12-19 change map api naver to daum (kakao)
// TODO: 2017-12-19 add find road api
        ...
        switch (requestCode) {
            case LOCATION_PERMISSION_CODE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getContext(), "권한을 거부하셨습니다. 이용에 제한이 생길 수 있습니다.", Toast.LENGTH_SHORT).show();
                    moveMapCenter();
                }
                break;
            }
...
// set POI data
    ...
    private boolean checkGPS() {
        ...
        if (manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            ...
            builder.setMessage("GPS 상태 변경 하러 가시겠습니까?");
            ...
            builder.setNegativeButton("No",
                    (dialog, which) -> Toast.makeText(getContext(), "이용제 제한이 생길 수 있습니다.", Toast.LENGTH_SHORT).show());
            builder.show();
            return false;
        }
    }
    ...
    private void event() {
        imgCurrentLocation.setOnClickListener(v -> permissionCheck());
    }
